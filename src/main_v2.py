...
def edit_draft_node(state: AgentState) -> dict:
    ...
    from prompts import draft_editing_prompt
    
    # Format the human message to include both original email and draft
...
{state["draft"]}"""
    ...
    messages = [
        SystemMessage(content=draft_editing_prompt),
...
builder.add_node("edit_draft_rejection", edit_draft_node)
...
builder.add_edge("soft_rejection_drafting", "edit_draft_rejection")
builder.add_edge("edit_draft_rejection", "slack_notification")
